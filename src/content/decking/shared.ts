import { DECK_CTA_URL, sites } from '../../config/sites';
import type { DeckFinalCta, DeckMobbsSection } from './deckGuidePage.types';

const deckCtaLabel =
	'primaryCta' in sites.decking ? sites.decking.primaryCta : 'Estimate Your Decking Construction Cost';
...
export const deckMobbsSection: DeckMobbsSection = {
	id: 'mobbs',
	title: 'When it helps to bring in the experts.',
	variant: 'alt',
	paragraphs: [
		'Made By Mobbs Landscapes designs and builds outdoor spaces in Melbourne — paving, planting, lighting and the decks that tie a backyard together.',
